...
training_fractions=( 0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 )
training_frac_str=( 5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80 )
num_models=16
...
training_frac_str=( 85 90 95 100 )
num_models=4
...
do
    ...
    log_suffix=spk_or_utt_closed_with_utility_spk_test_noBLEU_${training_frac_str}_pct_seed_${seed}
